...
Abaixo está o detalhamento do que foi feito e a finalidade de cada parte do código.
...
* **Para que serve:** Executa um código **obrigatoriamente**, ocorrendo um erro ou não. Em aplicações reais, é comumente usado para fechar conexões com banco de dados, fechar arquivos ou encerrar carregamentos da interface.
